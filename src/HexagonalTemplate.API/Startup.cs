...
using HexagonalTemplate.API.Extensions.Middleware;
using HexagonalTemplate.Application.Handlers;
using HexagonalTemplate.Application.Mappers;
using HexagonalTemplate.Application.Services;
using HexagonalTemplate.Domain.Tasks;
using HexagonalTemplate.Domain.Tasks.Commands;
using HexagonalTemplate.Domain.Tasks.Events;
using HexagonalTemplate.Infrastructure.Factories;
using HexagonalTemplate.Infrastructure.Repositories;
...
namespace HexagonalTemplate.API
{
